  ...
  >
   ...
   <div className="inline-block max-w-md p-4 my-5 overflow-hidden text-left align-middle transition-all transform bg-thyme-700 shadow-md rounded-lg">
        ...
        <ToolTip text="Easy">
            ...
            onclick={() => handleWordSelect( randomWords[0] ) }>
                {randomWords[0]}
            </button>
        </ToolTip>
        <br></br>
        ...
        <ToolTip text="Medium">
            ...
            onclick={() => handleWordSelect(randomWords[1])} >{randomWords[1]}</button>
        </ToolTip>
        <br></br>
        ...
        <ToolTip text="Hard">
            ...
            type="button" 
            className="px-4 py-2 text-sm font-medium shadow-md text-thyme-900 bg-thyme-100 rounded-md hover:bg-thyme-200"             
            onclick={() => handleWordSelect(randomWords[2])} >{randomWords[2]}</button>
        </ToolTip>
        </div>
